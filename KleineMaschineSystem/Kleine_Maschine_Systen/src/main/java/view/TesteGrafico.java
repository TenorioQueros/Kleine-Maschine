 ...
 */
public class TesteGrafico extends ApplicationFrame {
     ...
     */
    public TesteGrafico(String title) {
        super(title);
    ...
    private static PieDataset createDataset() {
        ...
        dataset.setValue("Consumo", new Double(cpuMODEL.consumoCPU()));
        dataset.setValue("Usada", new Double(cpuMODEL.naoUsada()));
    ...
    public static void main(String[] args) {
    	TesteGrafico demo = new TesteGrafico("JFreeChart: Ring Chart Demo 1");
        demo.pack();
